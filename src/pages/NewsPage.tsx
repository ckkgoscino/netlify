  ...
  const fetchEvents = async () => {
    try {
      const { data, error } = await supabase
        .from('events')
        .select('*, link') // 👈 pobiera też kolumnę link
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Sprawdź nadchodzące wydarzenia w naszym centrum
          </p>
        </div>
            ...
            {events.map((event) => {
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-xl hover:scale-[1.02] cursor-pointer ${
